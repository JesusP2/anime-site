...
import { createQuizSongSelectionSectionSchema, type SongSelectionSection } from "@/lib/schemas";
    ...
    <form onSubmit={e => {
      ...
      <Card>
                    ...
                    {field.state.value.map((song, index) => (
                      ...
                      >
                        <div className="flex gap-2">
                          <Badge variant="outline" className="shrink-0 h-6 mt-1">{index + 1}</Badge>
                          <div>
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            const newSongs = field.state.value.filter(song => song.id !== song.id)
        ...
        <CardFooter className="flex justify-between">
          <Button variant="outline" className="flex items-center" onClick={onBack} type="button">
