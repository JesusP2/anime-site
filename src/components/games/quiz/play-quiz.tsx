      ...
      <div className="max-w-3xl mx-auto">
          ...
          <CardContent>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 mb-6 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm">Click to {isPlaying ? "pause" : "play"} the opening</p>
              </div>
            </div>
              ...
              {currentQuizQuestion?.options.map((option) => (
                <Button
                  ...
                  variant={selectedAnswer === null ? "outline" : 
                          ...
                          option.id === currentQuizQuestion?.correctAnime && selectedAnswer !== null ? 
                            "default" : "outline"}
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Progress 
              value={((currentQuestion + (selectedAnswer !== null ? 1 : 0)) / totalQuestions) * 100} 
              className="h-2" 
            />
            <p className="text-center text-sm mt-2">
              {currentQuestion + (selectedAnswer !== null ? 1 : 0)} of {totalQuestions} questions
            </p>
          </CardContent>
        </Card>
      </div>
