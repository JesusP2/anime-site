                            ...
                            <tbody>
                              <tr>
                                <td style="width: 600px">
                                  <img
                                    alt="AniSearch"
                                    src="https://via.placeholder.com/600x80/232f3e/ffffff?text=Anime+App"
                                    style="
                                      border: 0;
                                      display: block;
                                      outline: none;
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        >
                          ...
                          >
                            Hello, <br /><br />
                            We received a login request for your account. If you
                            initiated this request, please use the following
                            magic link to securely access your account:
                          </div>
                        </td>
                      </tr>
