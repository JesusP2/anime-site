import { integer, pgTable, varchar, json, boolean, vector, timestamp } from "drizzle-orm/pg-core";
...
export const animeTable = pgTable("anime", {
  ...
  trailer: json("trailer").$type<
    components["schemas"]["trailer"]
  >(), //json
  approved: boolean("approved"), //boolean
  titles: json("titles")
    .notNull()
    .$type<components["schemas"]["title"][]>(), //json
  ...
  aired: json("aired")
    .notNull()
    .$type<components["schemas"]["daterange"]>(), //json
