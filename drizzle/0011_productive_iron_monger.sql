...
ALTER TABLE `anime` ALTER COLUMN "embedding" TO "embedding" F8_BLOB(1536);--> statement-breakpoint
...
ALTER TABLE `manga` ALTER COLUMN "embedding" TO "embedding" F8_BLOB(1536);